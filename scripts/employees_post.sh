...
employees=(
    "Angela Martin Accounting local-angela.png"
    "Creed Bratton Quality_Assurance local-creed.png"
    "Darryl Philbin Warehouse local-darryl.png"
    "David Wallace Management local-david.jpg"
    "Dwight Schrute Sales local-dwight.png"
    "Jan Levinson Management local-jan.png"
    "Jim Halpert Sales local-jim.png"
    "Kelly Kapoor Customer_Service local-kelly.png"
    ...
    "Ryan Howard Temp local-ryan.jpg"
