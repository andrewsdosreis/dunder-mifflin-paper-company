Feature: Employee Management
  ...
  Scenario: Retrieve an existing employee by ID
    Given an employee with firstName "Dwight" lastName "Schrute" department "Sales" and photo "dwight-test.png" exists
    When I can retrieve the employee by id
    Then I should see the employee details with firstName "Dwight" lastName "Schrute" department "Sales" and photo "employees/Dwight_Schrute.png"
    And the employee's trivia should be available
    And the employee's photo should be accessible in S3
